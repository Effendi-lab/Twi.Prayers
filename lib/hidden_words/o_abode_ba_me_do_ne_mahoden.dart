                  ...
                  actions: <Widget>[
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share(
                            "AHINTASƐM (Arabic Fa No)\n\n"
                            "O Abɔde Ba!\n"
                            "Me dɔ ne M'ahoɔden; nea ɔhyɛn mu no ho rentɔ kyima na ɔrenyera da, na nea ɔpa M'akyi no de, nokware, "
                            "ɔbɛyera na ɔbɛsɛe.\n\n"
                            "(9)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style: TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/OAbodeBa_MeDoNeMahoden.mp3"));
