...
class OAbodeBaNkaNkyereOkra extends StatefulWidget {
  @override
  _OAbodeBaNkaNkyereOkraState createState() => _OAbodeBaNkaNkyereOkraState();
}

class _OAbodeBaNkaNkyereOkraState extends State<OAbodeBaNkaNkyereOkra> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share("AHINTASƐM\n\n"
                            "O Abɔde Ba!\n"
                            "Nka nkyerɛ ɔkra biara sɛ ɔnyɛ biribi a wo ankasa worentumi nyɛ; afei nea worentumi "
                            "nyɛ biara no mmɔ so. Eyi yɛ Me mmara ma wo, enti di so.\n\n"
                            "(29)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style: TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                         _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/OAbodeBa_NkaNKyerɛOkra.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(29)", style: TextStyle(fontSize: 20*_scale,),
