...
class ONipaBaDiAhurusi extends StatefulWidget {
  @override
  _ONipaBaDiAhurusiState createState() => _ONipaBaDiAhurusiState();
}

class _ONipaBaDiAhurusiState extends State<ONipaBaDiAhurusi> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share("AHINTASƐM\n\n"
                            "O Nipa Ba!\n"
                            "Di ahurusi na nya anigye wɔ wo koma mu, sɛnea ɛbɛyɛ a wobɛtumi ahyia Me na woada M'ahoɔfɛ adi.\n\n"
                            "(36)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style:  TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_DiAhurusi.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(36)", style: TextStyle(fontSize: 20*_scale,),
