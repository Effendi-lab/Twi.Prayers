...
class ONipaBaMaMeNsomWoBo extends StatefulWidget {
  @override
  _ONipaBaMaMeNsomWoBoState createState() => _ONipaBaMaMeNsomWoBoState();
}

class _ONipaBaMaMeNsomWoBoState extends State<ONipaBaMaMeNsomWoBo> {
            ...
            child: Scaffold(
              appBar: PreferredSize( preferredSize: Size.fromHeight(50.0),
                child: GradientAppBar(
                  ...
                  centerTitle: true, elevation: 0.0, gradient: LinearGradient(colors: [Colors.black, Colors.red[300]]),
                  actions: <Widget>[
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0, ), onPressed: (){
                        ShareExtend.share("text"
                            "O Nipa Ba!\n"
                            "Ma Me nsom wo bo na nhwehwɛ ɔboafo biara. Efisɛ obiara nsom wo bo ka Me nkutoo ho.\n\n"
                            "(17)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style:  TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_MaMeNsomWoBo.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(17)", style: TextStyle(fontSize: 20*_scale,),
