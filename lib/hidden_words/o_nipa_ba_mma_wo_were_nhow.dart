...
class ONipaBaMmaWoWereNhow extends StatefulWidget {
  @override
  _ONipaBaMmaWoWereNhowState createState() => _ONipaBaMmaWoWereNhowState();
}

class _ONipaBaMmaWoWereNhowState extends State<ONipaBaMmaWoWereNhow> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share("AHINTASƐM\n\n"
                            "O Nipa Ba!\n"
                            "Mma wo werɛ nhow gye sɛ wo ne yɛn ntam ware. Na mma w'ani nnye gye sɛ wo retwiw abɛn Yɛn, "
                            "reba Yɛn nkyɛn.\n\n"
                            "(35)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style:  TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_MmaWoWerɛNhow.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(35)", style: TextStyle(fontSize: 20*_scale,),
