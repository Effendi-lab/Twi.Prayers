...
class ONipaBaNtow extends StatefulWidget {
  @override
  _ONipaBaNtowState createState() => _ONipaBaNtowState();
}

class _ONipaBaNtowState extends State<ONipaBaNtow> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share,size: 30.0, ), onPressed: (){
                        ShareExtend.share("AHINTASƐM\n\n"
                            "O Nipa Ba!\n"
                            "Ntow Me mmaransɛm nkyene sɛ wodɔ M'ahoɔfɛ de a, na mma wo werɛ mfi M'afotusɛm sɛ "
                            "wopɛ sɛ wo nsa ka nea M'áni ku ho de a.\n\n"
                            "(39)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style:  TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_NtowMeMmaransemNKyene.mp3;"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(39)", style: TextStyle(fontSize: 20*_scale,),
