...
class ONipaBaNyiMatade extends StatefulWidget {
  @override
  _ONipaBaNyiMatadeState createState() => _ONipaBaNyiMatadeState();
}

class _ONipaBaNyiMatadeState extends State<ONipaBaNyiMatade> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share("AHINTASƐM\n\n"
                            "O Nipa Ba!\n"
                            "Nyi (Nworɔw) M'atade fɛfɛɛfɛ no mfi wo ho, na mma wo kyɛfa wɔ M'asuten nwonwaso no "
                            "mu no mpare wo (mfi wo nsa), anyɛ saa de a osukɔm bɛde wo afebɔɔ.\n\n"
                            "(37)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style: TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_NyiMatadeFefeefeNo.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(37)", style: TextStyle(fontSize: 20*_scale,),
