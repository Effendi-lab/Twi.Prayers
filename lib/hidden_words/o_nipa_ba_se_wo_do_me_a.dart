...
class ONipaBaSeWoDoMeA extends StatefulWidget {
  @override
  _ONipaBaSeWoDoMeAState createState() => _ONipaBaSeWoDoMeAState();
}

class _ONipaBaSeWoDoMeAState extends State<ONipaBaSeWoDoMeA> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share("AHINTASƐM (Arabic Fa No)\n\n"
                            "O Nipa Ba!\n"
                            "Sɛ wodɔ Me a, pa wo ho akyi; na sɛ wohwehwɛ M'anigye a, ɛno de nhwehwɛ wo de; sɛnea "
                            "ɛbɛyɛ a wobɛwu wɔ Me mu na Matena wo mu afebɔɔ.\n\n"
                            "(7)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style:  TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_SeWoDoMe.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(7)", style: TextStyle(fontSize: 20*_scale,),
