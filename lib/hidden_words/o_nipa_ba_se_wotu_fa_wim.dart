...
class ONipaBaSeWotuFaWim extends StatefulWidget {
  @override
  _ONipaBaSeWotuFaWimState createState() => _ONipaBaSeWotuFaWimState();
}

class _ONipaBaSeWotuFaWimState extends State<ONipaBaSeWotuFaWim> {
                    ...
                    IconButton(
                      icon: Icon(Icons.share, size: 30.0,), onPressed: (){
                        ShareExtend.share("AHINTASƐM\n\n"
                            "O Nipa Ba!\n"
                            "Sɛ wotu fa wim, mmaa nyinaa, kyinkyin ɔsorosoro afanan nyinaa mpo a, "
                            "worennya ɔhoma bi, gye, wode wo ho hyɛ Yen mmara ase na wobrɛ wo ho ase wɔ Yɛn Anim.\n\n"
                            "(40)\n\n"
                  ...
                  child: GradientAppBar(title: Text("Ahintasɛm", style: TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/HiddenWordsAudio/ONipaBa_SeWotuFaWim.mp3"));
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("(40)", style: TextStyle(fontSize: 20*_scale,),
