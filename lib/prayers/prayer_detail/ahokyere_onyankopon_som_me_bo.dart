                ...
                child: GradientAppBar(
                  ...
                  actions: <Widget>[
                    IconButton(
                      ...
                      onPressed: (){
                        ShareExtend.share("AHOKYERE\n\n"
                            "Onyankopɔn som me bo, Nokware ni Ɔno na Ɔyɛ ade nyinaa. Wɔn a wɔgye no di no nya ne mu gyedi yiye. "
                            "(Wɔn a wɔgye no di no mma wɔn gyedi nsi pi wɔ Ne mu)\n\n"
                            "Báb\n\n\n"
                            "Onyame Nkae app", "text", sharePanelTitle: "Ahokyere", subject: "Twi Prayers",);
                      },
                    )
                  ],
                ),
                  ...
                  child: GradientAppBar(title: Text("Ahokyere", style:  TextStyle(fontSize: 20, fontFamily: "NotoSerif"),),
                    ...
                    actions: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.play_circle_outline,),
                        ...
                        onPressed: ()
                        {
                          _assetsAudioPlayer.open(Audio("audios/Ahokyere2_O_Nyankopon.mp3"));
                            ...
                            Row(
                              children: <Widget>[
                                Expanded(
                                  ...
                                  child: DropCapText("Onyankopɔn som me bo, Nokware ni Ɔno na Ɔyɛ ade nyinaa. Wɔn a wɔgye no di no nya ne mu gyedi yiye. "
                                      "(Wɔn a wɔgye no di no mma wɔn gyedi nsi pi wɔ Ne mu).",
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: AutoSizeText("Báb", style: TextStyle(fontSize: (20*_scale).clamp(12.0, 50.0), fontFamily: "NotoSans", fontWeight: FontWeight.bold),
